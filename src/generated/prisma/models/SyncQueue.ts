...
export type SyncQueueWhereInput = {
  ...
  errorMessage?: Prisma.StringNullableFilter<"SyncQueue"> | string | null
...
export type SyncQueueScalarWhereWithAggregatesInput = {
  ...
  errorMessage?: Prisma.StringNullableWithAggregatesFilter<"SyncQueue"> | string | null
...
export type SyncQueueOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "payload" | "status" | "attempts" | "lastAttemptAt" | "errorMessage" | "createdAt", ExtArgs["result"]["syncQueue"]>
...
export interface SyncQueueFieldRefs {
  ...
  readonly errorMessage: Prisma.FieldRef<"SyncQueue", 'String'>
